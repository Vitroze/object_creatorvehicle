hook.Add("AddToolMenuCategories", "AddToolMenuCategories_ObjetCreatorVehicle", function()
    spawnmenu.AddToolCategory("Utilities", "Objet Creator Vehicle", "Objet Creator Vehicle")
end)

local function ObjetCreatorVehicle_Panel(CPanel)
    CPanel:ClearControls()
    CPanel:AddControl("Header", { Description = "Objet Creator Vehicle allows you to generate a code for a vehicle with the props you put. This is used for example to create a flashing light ramp for example"})
    ...
    CPanel:AddControl("Button", { Text = "Visual", Command = "objet_creator_vehicle_visual"})
    CPanel:AddControl("Button", { Text = "Generate code", Command = "objet_creator_vehicle_generate_code" })
end

hook.Add("PopulateToolMenu", "PopulateToolMenu_ObjetCreatorVehicle", function()
    spawnmenu.AddToolMenuOption("Utilities", "Objet Creator Vehicle", "Objet Creator Vehicle", "Objet Creator Vehicle", "", "", ObjetCreatorVehicle_Panel)
end)
