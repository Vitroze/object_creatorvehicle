...
// Create a code automatically to put an objet on the vehicle in Lua
...
concommand.Add("objet_creator_vehicle_generate_code", function()
...
function Objet_CreatorVehicleVitroze:VisualProps(propModel, propVectorX, propVectorY, propVectorZ, propAngleYaw, propAnglePitch, propAngleRoll)
    local lp = LocalPlayer()
    if !IsValid(lp) then return end
...
concommand.Add("objet_creator_vehicle_visual", function() 
    Objet_CreatorVehicleVitroze:VisualProps(GetConVar("obcv_props"):GetString(), GetConVar("obcv_x"):GetFloat(), GetConVar("obcv_y"):GetFloat(), GetConVar("obcv_z"):GetFloat(), GetConVar("obcv_pitch"):GetFloat(), GetConVar("obcv_yaw"):GetFloat(), GetConVar("obcv_roll"):GetFloat())
end)